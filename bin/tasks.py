...
service_create_cmd = """avn --auth-token {auth_token} service create --enable-termination-protection --project {project} --service-type {service_type} --plan {plan} --cloud {cloud} -c pg_version={pg_version} {app_name}""".format
